...
from sb3_local.common.distributions import (
...
from sb3_local.common.preprocessing import get_action_dim, is_image_space, maybe_transpose, preprocess_obs
from sb3_local.common.torch_layers import (
...
class BaseModel2(nn.Module):
    ...
    @classmethod
    def load(cls: Type[SelfBaseModel], path: str, device: Union[torch.device, str] = "auto") -> SelfBaseModel:
        """
    ...
    def load_from_vector(self, vector: np.ndarray) -> None:
        ...
        :param vector:
        """
        torch.nn.utils.vector_to_parameters(torch.as_tensor(vector, dtype=torch.float, device=self.device), self.parameters())
...
class BasePolicy2(BaseModel2, ABC):
...
class FeedForward512Policy(ActorCriticPolicy):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, **kwargs, net_arch=[512, 512])


def policy_for_bc(observation_space: gym.Space, 
