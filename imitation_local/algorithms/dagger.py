...
from imitation_local.data import rollout, serialize, types
...
class InteractiveTrajectoryCollector(vec_env.VecEnvWrapper):
    ...
    an action from the imitation_local policy) is forwarded instead.
    ...
    def step_async(self, actions: np.ndarray) -> None:
        ...
        DAgger needs to be able to inject imitation_local policy actions randomly at some
        ...
        "robot" (i.e. imitation_local policy) action if necessary.
...
class DAggerTrainer(base.Baseimitation_localAlgorithm):
